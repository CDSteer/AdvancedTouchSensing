...
public void setup() {
  ...
  //nothing
  gesturePoints[0][0] = 55.0f;
  gesturePoints[0][1] = 1023.0f;

  //Touch: 61.0, 1023.0
  gesturePoints[1][0] = 61.0f;
  gesturePoints[1][1] = 1023.0f;

  //Hold: 92.0, 997.0
  gesturePoints[2][0] = 92.0f;
  gesturePoints[2][1] = 997.0f;

  //Squeeze: 105.0, 900.0
  gesturePoints[3][0] = 105.0f;
  gesturePoints[3][1] = 900.0f;

  //Soil: 143.0, 726.0
  gesturePoints[4][0] = 143.0f;
  gesturePoints[4][1] = 726.0f;
}
...
class Graph {
  ...
  float yMax=1500, yMin=0;      // Default axis dimensions
  float xMax=10, xMin=0;
  float yMaxRight=1500, yMinRight=0;
  ...
  public void DrawAxis() {
    ...
    for (int x=0; x<=xDiv; x++) {
      ...
      text(xAxisMS[0]+"."+xAxisMS[1].charAt(0), PApplet.parseFloat(x)/xDiv*Width+xPos-3, yPos+Height+15);   // x-axis Labels
    }
    ...
    for (int y=0; y<=yDiv; y++) {
      ...
      text(yAxisMS[0]+"."+yAxisMS[1].charAt(0), xPos-15, PApplet.parseFloat(yDiv-y)/yDiv*Height+yPos+3);    // y-axis Labels 
      ...
      if (RightAxis) {
        ...
        line(xPos+Width+3, PApplet.parseFloat(y)/yDiv*Height+yPos, xPos+Width+7, PApplet.parseFloat(y)/yDiv*Height+yPos);  // Right Y axis sub devisions
        textAlign(LEFT); 
  ...
  public void DotGraph(float[] x, float[] y) {
    for (int i=0; i<x.length; i++) {
      ...
      yPos+Height-(y[i]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height, 2, 2);
    }
  }
